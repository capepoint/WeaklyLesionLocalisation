...
def parse_args():
    ...
    parser.add_argument('--test_set_dir', '-td', type=str, default='./data_1/covid-cell_1',
                        help='folder to load test set')
    parser.add_argument('--gt_dir', '-gtd', type=str, default='./data_1/covid-cell_1/mask',
                        help='folder of ground truth')
    parser.add_argument('--save_dir', '-sd', type=str, default='./result_covid-cell/train_3_ep_93',
    ...
    parser.add_argument('--pretrain_unet_path', type=str, default='./check_points/train_3_ep_93/g.pkl',
...
class Predict:
    def __init__(self, args):
        ...
        self.prediction = []
        self.label = []
        self.segmentation_threshold = 40
